<div class="container-fluid p-0 m-0 bg-secondary text-light py-5 mb-2"  id="a-quien">
    ...
    <div class="row row justify-content-center">
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <div class="row row justify-content-end px-3 text-justify">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">
                    <p >Una empresa constructora puede hacer casas de mala calidad en distintos niveles, puede ser algo simple como una terminaci&oacute;n o un mal pintado,
                    ...
                    como tener que reconstruirla. La mejor excusa es <cite title="Source Title">&quot;Ning&uacute;n software estar&aacute; libre de errores&quot;</cite>, el tema es &iquest;Cu&aacute;les errores?</p>
                    
                    <p >Por muchos motivos existen problemas de calidad en un software, tambi&eacute;n existen (por motivos mucho m&aacute;s beneficiosos) formas de mejorar la calidad de lo que se construye.
                    ...
                    <p >Como ingenieros de software, tenemos la dif&iacute;cil tarea de mantener un software de mala calidad, de tratar de extender sus funcionalidades, de redise&ntilde;arlo y de ser
        ...
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 px-5">
            <img class="m-0 img-fluid" src="http://dancoa.com/wp-content/uploads/2017/11/ab2646c225ce2c1f2a40ea90115cf591.jpg" alt="Generic placeholder image">
        </div>
    </div>
</div>
...
<!-- <div class="container">
<div class="media">
  <img class="align-self-center mr-3" src="http://dancoa.com/wp-content/uploads/2017/11/ab2646c225ce2c1f2a40ea90115cf591.jpg" alt="Generic placeholder image">
